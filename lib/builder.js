 ...
 * @returns
 */
exports.identity = ast_1.Expression.identity;
/**
 * 创建一个表格标识
 ...
 */
exports.table = ast_1.Expression.identity;
exports.field = ast_1.Expression.identity;
...
exports.allFields = new ast_1.Identity('*');
// ************************** 系统函数区 *************************
function count(exp) {
