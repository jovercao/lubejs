...
exports.makeProxyIdentity = exports.ensureCondition = exports.ensureGroupValues = exports.ensureIdentity = exports.ensureConstant = exports.assert = void 0;
...
function ensureGroupValues(values) {
    if (_.isArray(values)) {
        return new ast_1.BracketExpression(new ast_1.ValueList(...values));
    }
    if (!(values instanceof ast_1.Bracket)) {
        return new ast_1.BracketExpression(values);
    }
    return values;
}
 ...
 * 将制作table的代理，用于生成字段
 */
function makeProxyIdentity(identifier) {
...
exports.makeProxyIdentity = makeProxyIdentity;
