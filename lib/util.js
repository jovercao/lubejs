...
exports.makeProxyIdentity = exports.ensureCondition = exports.ensureIdentity = exports.ensureConstant = exports.assert = void 0;
    ...
    return new Proxy(identifier, {
        get(target, prop) {
            ...
            if (_.isString(prop)) {
                ...
                return new ast_1.Identifier(prop, identifier);
            }
        }
    });
}
