...
exports.Document = exports.Parameter = exports.Declare = exports.Assignment = exports.Execute = exports.Delete = exports.Update = exports.Insert = exports.Select = exports.Fromable = exports.Union = exports.UnaryExpression = exports.BinaryExpression = exports.BracketCondition = exports.BracketExpression = exports.Bracket = exports.Constant = exports.Case = exports.When = exports.Statement = exports.Invoke = exports.Alias = exports.Variant = exports.AnyIdentifier = exports.Identifier = exports.Raw = exports.Join = exports.BinaryLogicCondition = exports.Condition = exports.Expression = exports.AST = void 0;
/**
 * lodash
 */
...
class Condition extends AST {
    ...
    static exists(select) {
        return new UnaryCompareCondition(constants_1.CompareOperator.EXISTS, Expression.quoted(select));
    }
    /**
     * 比较运算
     * @private
    ...
    static in(left, values) {
        ...
        return Condition.compare(left, group, constants_1.CompareOperator.IN);
    }
    /**
     * 比较运算 NOT IN
     * @param left 左值
    ...
    static notIn(left, values) {
        ...
        return Condition.compare(left, group, constants_1.CompareOperator.NOT_IN);
    }
    /**
     * 比较运算 IS NULL
     * @returns 返回比较运算符
...
class AnyIdentifier extends Identifier {
    constructor(parent) {
        super('*', parent, constants_1.SqlSymbol.ANY);
    }
}
...
class Select extends Fromable {
    ...
    orderBy(...sorts) {
        ...
        sorts = sorts;
        this.sorts = sorts.map(expr => _.isObject(expr) ? expr : {
...
class Insert extends Statement {
    ...
    values(...args) {
        ...
        this.rows = args.map(row => {
            return this.fields.map(field => util_1.ensureConstant(row[field.name]));
        });
        return this;
    }
}
...
class Update extends Fromable {
    ...
    set(...sets) {
        ...
        const obj = sets[0];
        this.sets = Object.entries(obj).map(([key, value]) => new Assignment(new Identifier(key), util_1.ensureConstant(value)));
        return this;
    }
}
...
class Parameter extends Expression {
    ...
    static input(name, value) {
        return new Parameter(name, value, constants_1.ParameterDirection.INPUT);
    }
    /**
     * output参数
     */
    static output(name, value) {
        return new Parameter(name, value, constants_1.ParameterDirection.OUTPUT);
    }
}
