...
exports.Document = exports.Parameter = exports.Declare = exports.Assignment = exports.Execute = exports.Delete = exports.Update = exports.Insert = exports.Select = exports.SortInfo = exports.Fromable = exports.Union = exports.UnaryExpression = exports.BinaryExpression = exports.BracketCondition = exports.BracketExpression = exports.Bracket = exports.ValueList = exports.Constant = exports.Case = exports.When = exports.Statement = exports.Invoke = exports.Alias = exports.Variant = exports.Identifier = exports.Raw = exports.Join = exports.BinaryLogicCondition = exports.Condition = exports.Expression = exports.AST = void 0;
/**
 * lodash
 */
...
const ExpressionPrototype = {
     ...
     */
    asc() {
        return new SortInfo(this, constants_1.SortDirection.ASC);
    },
    /**
     * 倒序
     * @returns 返回对比条件表达式
     */
    desc() {
        return new SortInfo(this, constants_1.SortDirection.DESC);
    },
    /**
     * 为当前表达式添加别名
     */
...
class Expression extends AST {
    ...
    static add(left, right) {
        return new BinaryExpression(constants_1.ComputeOperator.ADD, left, right);
    }
    /**
     * 算术运算 -
     * @param left 左值
    ...
    static sub(left, right) {
        return new BinaryExpression(constants_1.ComputeOperator.SUB, left, right);
    }
    /**
     * 算术运算 *
     * @param left 左值
    ...
    static mul(left, right) {
        return new BinaryExpression(constants_1.ComputeOperator.MUL, left, right);
    }
    /**
     * 算术运算 /
     * @param left 左值
    ...
    static div(left, right) {
        return new BinaryExpression(constants_1.ComputeOperator.DIV, left, right);
    }
    /**
     * 算术运算 %
     * @param left 左值
    ...
    static mod(left, right) {
        return new BinaryExpression(constants_1.ComputeOperator.MOD, left, right);
    }
    /**
     * 位算术运算 &
     * @param left 左值
    ...
    static and(left, right) {
        return new BinaryExpression(constants_1.ComputeOperator.BITAND, left, right);
    }
    /**
     * 位算术运算 |
     * @param left 左值
    ...
    static or(left, right) {
        return new BinaryExpression(constants_1.ComputeOperator.BITOR, left, right);
    }
    /**
     * 位算术运算 ^
     * @param left 左值
    ...
    static xor(left, right) {
        return new BinaryExpression(constants_1.ComputeOperator.BITXOR, left, right);
    }
    /**
     * 位算术运算 ~
     * @param left 左值
    ...
    static not(left, right) {
        return new BinaryExpression(constants_1.ComputeOperator.BITNOT, left, right);
    }
    /**
     * 位算术运算 <<
     * @param left 左值
    ...
    static shl(left, right) {
        return new BinaryExpression(constants_1.ComputeOperator.SHL, left, right);
    }
    /**
     * 位算术运算 >>
     * @param left 左值
    ...
    static shr(left, right) {
        return new BinaryExpression(constants_1.ComputeOperator.SHR, left, right);
    }
    /**
     * CASE语句表达式
     * @param expr 表达式
...
const ConditionPrototype = {
    ...
    andGroup(condition) {
        condition = util_1.ensureCondition(condition);
        return new BinaryLogicCondition(constants_1.LogicOperator.AND, this, Condition.quoted(condition));
    },
    /**
     * OR语句
     * @param condition
    ...
    orGroup(condition) {
        condition = util_1.ensureCondition(condition);
        return new BinaryLogicCondition(constants_1.LogicOperator.OR, this, Condition.quoted(condition));
    }
};
/**
 * 查询条件
...
class Condition extends AST {
    ...
    static exists(select) {
        return new UnaryCompareCondition(constants_1.CompareOperator.EXISTS, AST.bracket(select));
    }
    /**
     * 比较运算
     * @private
     ...
     * @returns 返回比较运算对比条件
     */
    static compare(left, right, operator = constants_1.CompareOperator.EQ) {
    ...
    static eq(left, right) {
        return Condition.compare(left, right, constants_1.CompareOperator.EQ);
    }
    /**
     * 比较运算 <>
     * @param left 左值
    ...
    static neq(left, right) {
        return Condition.compare(left, right, constants_1.CompareOperator.NEQ);
    }
    /**
     * 比较运算 <
     * @param left 左值
    ...
    static lt(left, right) {
        return Condition.compare(left, right, constants_1.CompareOperator.LT);
    }
    /**
     * 比较运算 <=
     * @param left 左值
    ...
    static lte(left, right) {
        return Condition.compare(left, right, constants_1.CompareOperator.LTE);
    }
    /**
     * 比较运算 >
     * @param left 左值
    ...
    static gt(left, right) {
        return Condition.compare(left, right, constants_1.CompareOperator.GT);
    }
    /**
     * 比较运算 >=
     * @param left 左值
    ...
    static gte(left, right) {
        return Condition.compare(left, right, constants_1.CompareOperator.GTE);
    }
    /**
     * 比较运算 LIKE
     * @param left 左值
    ...
    static like(left, right) {
        return Condition.compare(left, right, constants_1.CompareOperator.LIKE);
    }
    /**
     * 比较运算 NOT LIKE
     * @param left 左值
    ...
    static notLike(left, right) {
        return Condition.compare(left, right, constants_1.CompareOperator.NOT_LIKE);
    }
    /**
     * 比较运算 IN
     * @param left 左值
    ...
    static in(left, values) {
        return Condition.compare(left, util_1.ensureGroupValues(values), constants_1.CompareOperator.IN);
    }
    /**
     * 比较运算 NOT IN
     * @param left 左值
    ...
    static notIn(left, values) {
        return Condition.compare(left, util_1.ensureGroupValues(values), constants_1.CompareOperator.NOT_IN);
    }
    /**
     * 比较运算 IS NULL
     * @returns 返回比较运算符
...
class IsNullCondition extends UnaryCompareCondition {
     ...
     */
    constructor(next) {
        super(constants_1.CompareOperator.IS_NULL, next);
    }
}
/**
 * 是否为空值条件
...
class IsNotNullCondition extends UnaryLogicCondition {
     ...
     */
    constructor(next) {
        super(constants_1.CompareOperator.IS_NOT_NULL, next);
    }
}
/**
 * 联接查询
...
class Raw extends AST {
    constructor(sql) {
        super(constants_1.SqlSymbol.RAW);
        this.sql = sql;
    }
}
exports.Raw = Raw;
...
class Identifier extends Expression {
     ...
     * 标识符
     */
    constructor(name, parent, type = constants_1.SqlSymbol.IDENTIFIER) {
        super(type);
        this.name = name;
        if (parent) {
     ...
     */
    static buildIn(name) {
        return new Identifier(name, null, constants_1.SqlSymbol.BUILDIN_IDENTIFIER);
    }
    /**
     * 内建标识符
     */
    static any(parent) {
        return new Identifier('*', parent, constants_1.SqlSymbol.BUILDIN_IDENTIFIER);
    }
}
...
class Alias extends Identifier {
    ...
    constructor(expr, name) {
        super(name, null, constants_1.SqlSymbol.ALIAS);
 ...
 * 值列表（不含括号）
 */
class ValueList extends AST {
    constructor(...values) {
        super(constants_1.SqlSymbol.VALUE_LIST);
...
class BracketExpression extends Bracket {
}
exports.BracketExpression = BracketExpression;
class BracketCondition extends Bracket {
}
exports.BracketCondition = BracketCondition;
...
exports.Fromable = Fromable;
class SortInfo extends AST {
    constructor(expr, direction) {
        super(constants_1.SqlSymbol.SORT);
        this.expr = util_1.ensureConstant(expr);
...
class VariantDeclare extends AST {
    constructor(name, dataType) {
        super(constants_1.SqlSymbol.VARAINT_DECLARE);
        this.name = name;
...
class Declare extends Statement {
    constructor(...declares) {
        super(constants_1.SqlSymbol.DECLARE);
...
class Parameter extends Expression {
    constructor(name, dbType, value, direction = constants_1.ParameterDirection.INPUT) {
    ...
    static input(name, value) {
        return new Parameter(name, null, value, constants_1.ParameterDirection.INPUT);
    }
    /**
     * output参数
     */
    static output(name, type, value) {
        return new Parameter(name, type, value, constants_1.ParameterDirection.OUTPUT);
    }
}
...
class Document extends AST {
    constructor(...statements) {
        super(constants_1.SqlSymbol.DOCUMENT);
