...
class Expression extends AST {
    ...
    static identifier(...names) {
        ...
        return names.reduce((previous, current) => {
            ...
            return new Identifier(current, previous);
        });
    }
    /**
     * 调用表达式
...
class Identifier extends Expression {
     ...
     * 标识符
     */
    constructor(name, parent, isAlias = false) {
        if (isAlias) {
            super(constants_1.SqlSymbol.ALIAS);
        }
        else {
...
class Parameter extends Expression {
    constructor(value, name, direction = constants_1.ParameterDirection.INPUT) {
     ...
     * input 参数
     */
    static input(value, name) {
        return new Parameter(value, name, constants_1.ParameterDirection.INPUT);
    }
    /**
     * output参数
     */
    static output(value, name) {
        return new Parameter(value, name, constants_1.ParameterDirection.OUTPUT);
    }
}
