 ...
 */
 export abstract class Expression<T extends Scalar = Scalar> extends AST implements Expression {
  ...
  concat(expr: CompatibleExpression<string>): Expression<string> {
    return BinaryOperation.concat(this as CompatibleExpression<string>, expr);
  }
  ...
  add(
    ...
    return BinaryOperation.add(this as any, expr as any);
  }
  ...
  sub(expr: CompatibleExpression<T>): Expression<T> {
    return BinaryOperation.sub(this as any, expr as any);
  }
  ...
  mul(expr: CompatibleExpression<T>): Expression<T> {
    return BinaryOperation.mul(this as any, expr as any);
  }
  ...
  div(expr: CompatibleExpression<T>): Expression<T> {
    return BinaryOperation.div(this as any, expr as any);
  }
  ...
  mod(expr: CompatibleExpression<T>): Expression<T> {
    return BinaryOperation.mod(this as any, expr);
  }
  ...
  and(expr: CompatibleExpression<T>): Expression<T> {
    return BinaryOperation.and(this as any, expr);
  }
  ...
  or(expr: CompatibleExpression<T>): Expression<T> {
    return BinaryOperation.or(this as any, expr);
  }
  ...
  xor(expr: CompatibleExpression<T>): Expression<T> {
    return BinaryOperation.xor(this as any, expr as any);
  }
  ...
  shl(expr: CompatibleExpression<T>): Expression<T> {
    return BinaryOperation.shl(this as any, expr as any);
  }
  ...
  shr(expr: CompatibleExpression<T>): Expression<T> {
    return BinaryOperation.shr(this as any, expr as any);
  }
  ...
  like(expr: CompatibleExpression<string>): Condition {
    return BinaryCompareCondition.like(this as CompatibleExpression<string>, expr);
  }
  ...
  notLike(expr: CompatibleExpression<string>): Condition {
    return BinaryCompareCondition.notLike(this as CompatibleExpression<string>, expr);
  }
