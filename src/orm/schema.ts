...
import { ColumnMetadata, ForeignRelation, IndexMetadata, isForeignRelation, isTableEntity, isViewEntity, TableEntityMetadata, ViewEntityMetadata } from "./metadata";
import { compareObject, EqulsCompartor, ObjectDifference, ObjectKeyCompartor } from "./compare";
   ...
   function genViewSchema(view: ViewEntityMetadata): ViewSchema {
     const v: ViewSchema = {
       ...
       scripts: sqlUtil.sqlify(
         SQL.createView(view.dbName).as(view.body)
       ).sql,
