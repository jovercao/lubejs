...
* [alias](_ast_.identifier.md#static-alias)
...
\+ **new Identifier**(`name`: string, `parent?`: [UnsureIdentifier](../modules/_ast_.md#unsureidentifier), `type`: [SQL_SYMBOLE](../enums/_constants_.sql_symbole.md)): *[Identifier](_ast_.identifier.md)*
