...
* [$args](_ast_.execute.md#readonly-args)
* [$proc](_ast_.execute.md#readonly-proc)
* [$type](_ast_.execute.md#readonly-type)

### Methods

* [clone](_ast_.execute.md#clone)
...
* [invoke](_ast_.execute.md#static-invoke)
* [invokeScalarFunction](_ast_.execute.md#static-invokescalarfunction)
* [invokeTableFunction](_ast_.execute.md#static-invoketablefunction)
* [makeFunc](_ast_.execute.md#static-makefunc)
* [makeProc](_ast_.execute.md#static-makeproc)
* [raw](_ast_.execute.md#static-raw)
* [select](_ast_.execute.md#static-select)
* [union](_ast_.execute.md#static-union)
* [unionAll](_ast_.execute.md#static-unionall)
* [update](_ast_.execute.md#static-update)
* [when](_ast_.execute.md#static-when)
* [with](_ast_.execute.md#static-with)

## Constructors

###  constructor

\+ **new Execute**(`proc`: [Name](../modules/_ast_.md#name)‹string› | [Procedure](_ast_.procedure.md)‹R, O, string›, `params?`: [CompatibleExpression](../modules/_ast_.md#compatibleexpression)‹[ScalarType](../modules/_types_.md#scalartype)›[]): *[Execute](_ast_.execute.md)*

Defined in ast.ts:3892
...
• **$args**: *[Expression](_ast_.expression.md)‹[ScalarType](../modules/_types_.md#scalartype)›[]*

Defined in ast.ts:3890

___

### `Readonly` $proc

• **$proc**: *[Procedure](_ast_.procedure.md)‹R, O, string›*

Defined in ast.ts:3889

___

### `Readonly` $type

• **$type**: *[EXECUTE](../enums/_constants_.sql_symbole.md#execute)* = SQL_SYMBOLE.EXECUTE
