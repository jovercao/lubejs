...
* [proxyIdentifier](_ast_.case.md#static-proxyidentifier)
...
▸ **when**(`expr`: [UnsureExpression](../modules/_ast_.md#unsureexpression), `then`: any): *this*

Defined in src/ast.ts:1423
